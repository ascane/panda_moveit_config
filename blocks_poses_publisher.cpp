...
#include <panda_moveit_config/blocks_poses.h>
...
int main(int argc, char** argv) {
    ...
    ros::Publisher poses_publisher
        = nh.advertise<panda_moveit_config::blocks_poses>("blocks_poses", 1);
    panda_moveit_config::blocks_poses current_poses_msg;
